...
with_jquery(function ($) {
	...
	var sendStatistics = function () {
		...
		$.get(url + encodeURIComponent(optionsData), function (data) {
			lastVersion = data;
			if(lastVersion == "OK") {
				...
				addTextToShoutbox("[FTDB Shoutbox Mod]", "/?section=FORUMS&module=mod_forums&forum_id=6&topic_id=6332", "class_70", '<a href="/?section=FORUMS&module=mod_forums&forum_id=6&topic_id=6332">Une nouvelle version est disponible (' + lastVersion + ') !</a> La mise à jour devrait être automatique au prochain redémarage de Chrome.');
			}
	...
	*/
	...
	var optionsDB = {
		opt: {
			...
			tabirc: {defaultVal: false, type: "check", requires: ["#check_tabirc", "#check_tabnames", "#check_userlist"], frame: "#option_input", text: 'Méthode IRC (Pas de suggestion)', reqLast: true},
