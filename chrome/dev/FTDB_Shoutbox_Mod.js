	...
	*/
	...
	var optionsDB = {
		opt: {
			...
			linkimages: {defaultVal: false, type: "check", requires: ["#check_linkimages", "#check_shoutbox"], frame: "#option_shoutbox", text: 'Ajouter un lien aux images pour les voir en taille réelle', reqLast: false},
