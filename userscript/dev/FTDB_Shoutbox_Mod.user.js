...
// @match           *://*.frenchtorrentdb.com/?section=COMMUNAUTE
...
// From 0.4.18
// ! Debug stuff
// ! localStorage missing announce
// + Friend / Ignore list
// + Context menu on gone/incomming users
// + usersmiley commands
// + usercommands
// From 0.4.19
// ! Image load scroll
...
with_jquery(function ($) {
	...
	var debug = true, scriptVersion = '0.4.19.149';
	...
	var playNotification = function (type, test, soundFileTest) {
		...
		$("#website").append('<embed id="notification" type="application/x-shockwave-flash" flashvars="audioUrl=https://thetabx.net/download/audio/notifications/' + soundFile + '&autoPlay=true" src="https://www.google.com/reader/ui/3523697345-audio-player.swf" width="0" height="0" quality="best"></embed>');
